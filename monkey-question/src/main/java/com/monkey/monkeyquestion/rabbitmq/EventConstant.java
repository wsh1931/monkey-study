...
public class EventConstant {
    ...
    // 问答回复数 + 1(问答回复表)
    public static final String questionCommentCountAddOne = "questionCommentCountAddOne";
    // 问答点赞数 + 1
    ...
    // 插入elasticsearch问答表
    public static final String insertElasticsearchQuestion = "insertElasticsearchQuestion";
}
