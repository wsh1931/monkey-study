<template>
    <div class="MonkeyWebUserHomeFans-container">
        <div
...
export default {
    ...
    data() {
        return {
            ...
            pageSize: 10,
            totals: 0,
            userHomeFansUrl: "http://localhost:80/monkey-user/home/fans",
    ...
    created() {
        ...
        this.queryUserFansById(this.userId);
    },
    ...
    methods: {
            ...
            $.ajax({
                ...
                success(response) {
                    if (response.code == vue.ResultStatus.SUCCESS) {
                        ...
                        vue.queryUserFansById(vue.userId);
                    } else {
        ...
        // 通过用户id查询用户粉丝
        queryUserFansById(userId) {
            const vue = this;
            $.ajax({
                url: vue.userHomeFansUrl + "/queryUserFansById",
                type: "get",
                data: {
                    userId,
