<template>
    <div class="MonkeyWebReportContent-container">
        <div class="position">
            <div class="header">
...
export default {
    name: 'MonkeyWebReportContent',
    props: ['reportContentType', 'reportContentAssociationId'],
    data() {
        return {
            // 一级举报id
            selectedOneReportId: "",
    ...
    methods: {
        // 提交举报内容类型
        submitReportContentType() {
            const vue = this;
            $.ajax({
                url: vue.reportUrl + "/submitReportContentType",
                type: "post",
                data: {
                    oneReportTypeId: vue.selectedOneReportId,
                    twoReportTypeId: vue.selectedTwoReportId,
                    reportDetail: vue.reportDetail,
                    reportContentType: vue.reportContentType,
                    reportContentAssociationId: vue.reportContentAssociationId,
                },
                headers: {
...
.MonkeyWebReportContent-container {
    z-index: 20000;
    position: fixed;
    height: 100%; 
    width: 100%; 
