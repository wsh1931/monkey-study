  ...
  <el-menu :default-active="$route.path"
   ...
   style="display: flex; justify-content: center; align-items: center; width: 100%;"
    ...
    <el-submenu  index="8">
      ...
      <el-menu-item index="/article/monkey-article/publishArticleViews">发布文章</el-menu-item>
      <el-menu-item index="/question/monkey-article/publishQuestionViews">发布问答</el-menu-item>
