...
public class ESArticleServiceImpl implements ESArticleService {
    ...
    public R insertArticleDocument() {
        try {
            ...
            for (ESArticleIndex article : esArticleIndexList) {
                br.operations(op -> op
                        .index(idx -> idx
     ...
     * @return {@link null}
     * @author wusihao
     * @date 2023/11/8 11:07
     */
    @Override
    public R queryArticle(Integer currentPage, Integer pageSize, String keyword) {
        try {
            ...
            SearchResponse<ESArticleIndex> response = elasticsearchClient.search(s -> s
                    ...
                    .from(location)
                    .size(pageSize), ESArticleIndex.class);
